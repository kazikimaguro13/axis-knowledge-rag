...
採用ポートフォリオとして React/Next.js 経験を示したい一方、
...
- ✅ 採用面接で「UI フレームワーク選定の判断ができる」と示せる
...
- ✅ 採用担当者が clone してすぐ動かせる (API キーなしでも UI が立ち上がる)
...
一方で「テストもリンタもない」状態は採用ポートフォリオとして弱い。
