...
- [architecture.md](architecture.md) — システム全体像、コンポーネント図、データフロー、デプロイ構成
- [design-decisions.md](design-decisions.md) — 主要な設計判断 (ADR) 12 件
- [api-reference.md](api-reference.md) — モジュール別 public API リファレンス
...
- _(TBD)_ deployment.md — v0.3.0 で追加予定 (Next.js + FastAPI 移行時)
