...
正規化パイプラインを適用します。実装は `backend/src/normalizer.py`、
公開 API は [`api-reference.md`](api-reference.md#backendsrcnormalizer) を参照。
...
- [architecture.md](architecture.md) — Normalizer がパイプラインのどこに位置するか
- [design-decisions.md](design-decisions.md#adr-007) — `normalized_*` 別フィールド方針の根拠 (ADR-007)
- [api-reference.md](api-reference.md#backendsrcnormalizer) — `Normalizer` / `NormalizerOptions` API
